...
### Application au problème de classification des entreprises

- Télécharger le modèle pré-entrainé
- Fine-tuning sur nos données
- Algorithme KNN pour la classification
- Résultats et outil pour les souscripteurs
...
![](images/sbert1.png){width=240 fig-align="center"}
:::

::: {.column width='50%' style='text-align: center;'}
[À l'inférence]{style='text-decoration: underline;'}

![](images/sbert2.png){width=150 fig-align="center"}
:::

:::


# Application au problème de classification d'entreprises

On a téléchargé le modèle SBERT à partir d'HuggingFace. Plus précisément, il s'agit du modèle [all-mpnet-base-v2](https://huggingface.co/sentence-transformers/all-mpnet-base-v2) Ensuite, on l'a fine-tuné sur des paires code IBC/description d'entreprises. On peut ensuite obtenir un embedding pour chaque description d'entreprise et de code IBC. 
...
| Indice | IBC Code | IBC Code Description |
|-|--|----|
...
| Indice | Company Description | IBC Code |
|-|----|----|
...
On va ensuite entrainer le modèle à rapprocher les [**paires positives**]{style='color: #007d57;'} et à éloigner les [**paires négatives**]{style='color: #650b22;'}.

::: {.callout-note appearance="simple"}
L'entrainement se fait en définissant une **fonction de perte** qui va « punir » les mauvaises classifications en appliquant la **descente de gradient**.
:::
...
[https://www.youtube.com/watch?v=eMlx5fFNoYc](Attention in transformers, visually explained -- 3Blue1Brown)


## Histoire {.small-text-slide}
